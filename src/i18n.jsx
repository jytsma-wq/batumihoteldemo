...
const ui = {
  en: {
    ...
    home: {
      ...
      motionAria: "Animated Batumi hotel finder",
      motionTitle: "Move through Batumi before you choose a room.",
      motionBody:
        "Follow the coast from Old Batumi to Gonio and Kvariati, compare beach access and area mood, then open the live map when a stay feels right.",
      motionMapCta: "Open hotel map",
      motionPause: "Pause motion",
      motionPlay: "Play motion",
      motionShowHotel: "Show {{hotelName}}",
      motionHotelAlt: "{{hotelName}} in {{areaName}}",
      motionViewStay: "View this stay",
      motionTickerAria: "Moving hotel search examples",
      motionTickerItems: [
        "quiet beach stays",
        "Old Batumi cafe streets",
        "sea-view rooms",
        "parking-friendly guesthouses",
        "family rooms near the boulevard"
      ],
      trustItems: [
        "Real photos",
        "Local area notes",
    ...
    map: {
      ...
      allStays: "All stays",
      loading: "Loading Batumi map...",
      help: "Pan, zoom and click hotel pins",
      hotelAlt: "{{hotelName}} in {{areaName}}"
    },
    about: {
  ...
  ru: {
    ...
    home: {
      ...
      motionTitle: "Пройдите по Батуми до выбора номера.",
      motionBody: "Следуйте вдоль побережья от Старого Батуми до Гонио и Квариати, сравните доступ к пляжу и настроение района, затем откройте живую карту.",
      motionMapCta: "Открыть карту отелей",
      motionPause: "Пауза",
      motionPlay: "Запустить",
      motionShowHotel: "Показать {{hotelName}}",
      motionHotelAlt: "{{hotelName}} в {{areaName}}",
      motionViewStay: "Смотреть вариант",
      motionTickerAria: "Движущиеся примеры поиска отелей",
      motionTickerItems: ["тихие места у пляжа", "кафейные улицы Старого Батуми", "номера с видом на море", "гестхаусы с парковкой", "семейные номера у бульвара"],
    ...
    map: { title: "Небольшие отели по районам Батуми", disclaimer: "Локации примерные. Точный адрес уточняйте у отеля.", allStays: "Все варианты", loading: "Загружается карта Батуми...", help: "Двигайте карту, меняйте масштаб и нажимайте метки", hotelAlt: "{{hotelName}} в {{areaName}}" },
  ...
  ka: {
    ...
    home: { title: "იპოვეთ პატარა სასტუმრო ბათუმში, რომელიც თქვენს მოგზაურობას ერგება.", subtitle: "დამოუკიდებელი სასტუმროები, გესთჰაუსები და ადგილობრივი ოთახები ბათუმში — რეალური ფოტოებით, უბნის შენიშვნებით და პირდაპირი WhatsApp მოთხოვნებით.", intentTitle: "როგორი დარჩენა გჭირდებათ?", featuredTitle: "გამორჩეული პატარა სასტუმროები", featuredBody: "შეადარეთ უბანი, ატმოსფერო და პრაქტიკული დეტალები პირდაპირ მოთხოვნამდე.", areasTitle: "სად დარჩეთ ბათუმში", collectionsTitle: "უფრო სწრაფად იპოვეთ შესაფერისი ადგილი", trustTitle: "რატომ Small Hotels Batumi?", trustBody: "ვხმარობთ მოგზაურებს სასტუმროს, უბნისა და პრაქტიკული დეტალების გაგებაში კონტაქტამდე.", guideTitle: "ადგილობრივი განთავსების გიდი", motionAria: "ანიმირებული ბათუმის სასტუმროების ძიება", motionTitle: "გაიარეთ ბათუმი, სანამ ოთახს აირჩევთ.", motionBody: "მიყევით სანაპიროს ძველი ბათუმიდან გონიომდე და კვარიათამდე, შეადარეთ პლაჟთან წვდომა და უბნის განწყობა, შემდეგ გახსენით ცოცხალი რუკა.", motionMapCta: "სასტუმროების რუკის გახსნა", motionPause: "მოძრაობის შეჩერება", motionPlay: "მოძრაობის ჩართვა", motionShowHotel: "{{hotelName}}-ის ჩვენება", motionHotelAlt: "{{hotelName}} {{areaName}}-ში", motionViewStay: "ამ ადგილის ნახვა", motionTickerAria: "სასტუმროს ძიების მოძრავი მაგალითები", motionTickerItems: ["მშვიდი პლაჟის ადგილები", "ძველი ბათუმის კაფეების ქუჩები", "ოთახები ზღვის ხედით", "პარკინგიანი გესთჰაუსები", "ოჯახური ოთახები ბულვართან"], trustItems: ["რეალური ფოტოები", "უბნის შენიშვნები", "პირდაპირი კონტაქტი", "დამოუკიდებელი ობიექტები", "პრაქტიკული დეტალები", "მარტივი WhatsApp მოთხოვნები"] },
    ...
    map: { title: "პატარა სასტუმროები ბათუმის უბნების მიხედვით", disclaimer: "ლოკაციები დაახლოებულია. ზუსტი მისამართი გადაამოწმეთ სასტუმროსთან.", allStays: "ყველა ადგილი", loading: "ბათუმის რუკა იტვირთება...", help: "გადაადგილეთ, დააახლოვეთ და დააწკაპეთ სასტუმროს ნიშნულებზე", hotelAlt: "{{hotelName}} {{areaName}}-ში" },
  ...
  tr: {
    ...
    home: { title: "Batum’da yolculuğunuza gerçekten uyan küçük oteli bulun.", subtitle: "Batum’da bağımsız oteller, misafirhaneler ve yerel odalar — gerçek fotoğraflar, bölge notları ve doğrudan WhatsApp istekleriyle.", intentTitle: "Nasıl bir konaklama arıyorsunuz?", featuredTitle: "Öne çıkan küçük oteller", featuredBody: "Doğrudan istek göndermeden önce bölge, atmosfer ve pratik detayları karşılaştırın.", areasTitle: "Batum’da nerede kalmalı", collectionsTitle: "Doğru konaklamayı daha hızlı bulun", trustTitle: "Neden Small Hotels Batumi?", trustBody: "Gezginlerin tesis, bölge ve pratik detayları iletişime geçmeden önce anlamasına yardım ederiz.", guideTitle: "Yerel konaklama rehberi", motionAria: "Hareketli Batum otel bulucu", motionTitle: "Oda seçmeden önce Batum’da ilerleyin.", motionBody: "Eski Batum’dan Gonio ve Kvariati’ye kadar kıyıyı takip edin, plaja erişimi ve bölge havasını karşılaştırın, sonra canlı haritayı açın.", motionMapCta: "Otel haritasını aç", motionPause: "Hareketi duraklat", motionPlay: "Hareketi başlat", motionShowHotel: "{{hotelName}} göster", motionHotelAlt: "{{areaName}} içinde {{hotelName}}", motionViewStay: "Bu konaklamayı gör", motionTickerAria: "Hareketli otel arama örnekleri", motionTickerItems: ["sakin plaj konaklamaları", "Eski Batum kafe sokakları", "deniz manzaralı odalar", "otoparklı misafirhaneler", "bulvara yakın aile odaları"], trustItems: ["Gerçek fotoğraflar", "Bölge notları", "Doğrudan iletişim", "Bağımsız küçük tesisler", "Pratik bilgiler", "Basit WhatsApp istekleri"] },
    ...
    map: { title: "Batum bölgelerine göre küçük oteller", disclaimer: "Konumlar yaklaşık gösterilir. Kesin adresi tesisten doğrulayın.", allStays: "Tüm konaklamalar", loading: "Batum haritası yükleniyor...", help: "Haritayı kaydırın, yakınlaştırın ve otel pinlerine tıklayın", hotelAlt: "{{areaName}} içinde {{hotelName}}" },
  ...
  he: {
    ...
    home: { title: "מצאו מלון קטן בבאטומי שבאמת מתאים לטיול שלכם.", subtitle: "מלונות עצמאיים, בתי הארחה וחדרים מקומיים בבאטומי — עם תמונות אמיתיות, הערות אזור ובקשות WhatsApp ישירות.", intentTitle: "איזו שהייה אתם מחפשים?", featuredTitle: "מלונות קטנים נבחרים", featuredBody: "השוו אזור, אווירה ופרטים מעשיים לפני שליחת בקשה ישירה.", areasTitle: "איפה כדאי לשהות בבאטומי", collectionsTitle: "מצאו את השהייה הנכונה מהר יותר", trustTitle: "למה Small Hotels Batumi?", trustBody: "אנחנו עוזרים למטיילים להבין את המלון, האזור והפרטים המעשיים לפני יצירת קשר.", guideTitle: "מדריך לינה מקומי", motionAria: "מחפש מלונות מונפש בבאטומי", motionTitle: "עברו בבאטומי לפני שבוחרים חדר.", motionBody: "עקבו אחרי החוף מבאטומי העתיקה עד גוניו וקוואריאטי, השוו גישה לחוף ואווירת אזור, ואז פתחו את המפה החיה.", motionMapCta: "פתחו מפת מלונות", motionPause: "השהיית תנועה", motionPlay: "הפעלת תנועה", motionShowHotel: "הצגת {{hotelName}}", motionHotelAlt: "{{hotelName}} ב{{areaName}}", motionViewStay: "צפייה בשהייה הזו", motionTickerAria: "דוגמאות חיפוש מלונות בתנועה", motionTickerItems: ["שהיות חוף שקטות", "רחובות בתי קפה בבאטומי העתיקה", "חדרים עם נוף לים", "בתי הארחה עם חניה", "חדרי משפחה ליד השדרה"], trustItems: ["תמונות אמיתיות", "הערות אזור", "קשר ישיר", "נכסים קטנים עצמאיים", "פרטים חשובים", "בקשות WhatsApp פשוטות"] },
    ...
    map: { title: "מלונות קטנים לפי אזור בבאטומי", disclaimer: "המיקומים משוערים. אשרו כתובת מדויקת מול המלון.", allStays: "כל השהיות", loading: "מפת באטומי נטענת...", help: "הזיזו, הגדילו ולחצו על סיכות המלונות", hotelAlt: "{{hotelName}} ב{{areaName}}" },
  ...
  ar: {
    ...
    home: { title: "اعثر على فندق صغير في باتومي يناسب رحلتك فعلا.", subtitle: "فنادق مستقلة وبيوت ضيافة وغرف محلية في باتومي — مع صور حقيقية وملاحظات عن المناطق وطلبات WhatsApp مباشرة.", intentTitle: "ما نوع الإقامة التي تبحث عنها؟", featuredTitle: "فنادق صغيرة مختارة", featuredBody: "قارن المنطقة والأجواء والتفاصيل العملية قبل إرسال طلب مباشر.", areasTitle: "أين تقيم في باتومي", collectionsTitle: "اعثر على الإقامة المناسبة أسرع", trustTitle: "لماذا Small Hotels Batumi؟", trustBody: "نساعد المسافرين على فهم الفندق والمنطقة والتفاصيل العملية قبل التواصل مع العقار.", guideTitle: "دليل محلي للإقامة", motionAria: "باحث فنادق متحرك في باتومي", motionTitle: "تنقل في باتومي قبل اختيار الغرفة.", motionBody: "اتبع الساحل من باتومي القديمة إلى غونيو وكفارياتي، وقارن الوصول إلى الشاطئ وأجواء المنطقة، ثم افتح الخريطة الحية.", motionMapCta: "افتح خريطة الفنادق", motionPause: "إيقاف الحركة", motionPlay: "تشغيل الحركة", motionShowHotel: "عرض {{hotelName}}", motionHotelAlt: "{{hotelName}} في {{areaName}}", motionViewStay: "عرض هذه الإقامة", motionTickerAria: "أمثلة متحركة للبحث عن الفنادق", motionTickerItems: ["إقامات هادئة قرب الشاطئ", "شوارع مقاهي باتومي القديمة", "غرف بإطلالة بحرية", "بيوت ضيافة مع موقف سيارات", "غرف عائلية قرب البوليفارد"], trustItems: ["صور حقيقية", "ملاحظات محلية", "تواصل مباشر", "عقارات صغيرة مستقلة", "تفاصيل مفيدة", "طلبات WhatsApp بسيطة"] },
    ...
    map: { title: "فنادق صغيرة حسب مناطق باتومي", disclaimer: "المواقع تقريبية. أكد العنوان الدقيق مع الفندق.", allStays: "كل الإقامات", loading: "جار تحميل خريطة باتومي...", help: "حرّك الخريطة وقرّبها واضغط على علامات الفنادق", hotelAlt: "{{hotelName}} في {{areaName}}" },
